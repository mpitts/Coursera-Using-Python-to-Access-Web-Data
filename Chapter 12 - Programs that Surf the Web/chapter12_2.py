...
# Chapter 12 Assignment: Scraping Numbers from HTML using BeautifulSoup

# In this assignment you will write a Python program similar to
# http://www.pythonlearn.com/code/urllink2.py. The program will use urllib to
...
# Actual data: http://python-data.dr-chuck.net/comments_201878.html
# (Sum ends with 81)
...
url = 'http://python-data.dr-chuck.net/comments_201878.html'
